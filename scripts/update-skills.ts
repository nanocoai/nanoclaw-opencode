...
import { commandAvailable, portableDependencyCommand } from './portable-dependency-command.js';

export { portableDependencyCommand } from './portable-dependency-command.js';
